...
function search(){
  ...
  $.get(
      "https://www.googleapis.com/youtube/v3/search", {
        ...
        q: q,
        type: 'video',
        key: "AIzaSyAwoXuUFDkmfB7yXt12HG32geNfrEJbJ4E"},
        function(data){
...
function getOutput(item){
  ...
  '</div>' + '<div class="list-right">' + '<h3><a class="fancybox fancybox.iframe" href="http://www.youtube.com/embed/'+videoId+'">' + title + '</a></h3>' +
